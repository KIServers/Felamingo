...
jQuery(document).ready(function($) {
	...
	foodmood_farsica_helper();
	foodmood_farsica_tools();
	foodmood_farsica_filters();
	foodmood_farsica_tabs();
	foodmood_farsica_login_in();
	...
	foodmood_farsica_mini_cart();
	foodmood_farsica_notifications();
